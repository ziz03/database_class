    ...
    <section id="products" class="py-5 mb-5">   
        <div class="container-fluid">
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <div class="card h-100 text-center" style="max-width: 300px; margin: 0 auto;">
                        <img src="https://sitestorage.notorious-2019.com/product/240111002_g1_1.jpg"
                            class="card-img-top" alt="產品 2">
                        <div class="card-body">
                            <h5 class="card-title">產品 2</h5>
                            <a href="#" class="btn btn-outline-primary btn-sm">查看詳情</a>
                            <form method="POST" action="action/cart.php">
                                <input type="hidden" name="action" value="add">
                                <input type="hidden" name="product" value="產品 2">
                                <button type="submit" class="btn btn-primary btn-sm">加入購物車</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <div class="card h-100 text-center" style="max-width: 300px; margin: 0 auto;">
                        <img src="https://sitestorage.notorious-2019.com/product/180101014_g8_1.jpg"
                            class="card-img-top" alt="產品 3">
                        <div class="card-body">
                            <h5 class="card-title">產品 3</h5>
                            <a href="#" class="btn btn-outline-primary btn-sm">查看詳情</a>
                            <form method="POST" action="action/cart.php">
                                <input type="hidden" name="action" value="add">
                                <input type="hidden" name="product" value="產品 3">
                                <button type="submit" class="btn btn-primary btn-sm">加入購物車</button>
                            </form>
                        </div>
                    </div>
