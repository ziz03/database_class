...
<nav class="navbar navbar-expand-lg  navbar-dark py-4" style="background-color: black;">
    ...
    <div class="container-fluid align-items-center">
        ...
        // 使用特別為導航欄定制的樣式設定
        displaySearchForm('d-flex me-auto', 'search-input', 'btn-outline-light', '搜尋書籍', '搜尋');
        ?>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="Allproduct.php">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <?php if (!empty($_SESSION['loggedin'])): ?>
                    ...
                    <?php else: ?>
                        <!-- 如果是普通使用者 -->
                        <li class="nav-item">
                            <a class="nav-link active" href="userCenter.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link active" href="action/logout.php">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
